...
{/* Links de Rodapé */}
        <div className="mt-8 text-center border-t border-slate-100 pt-6 space-y-3">
          <div>
            <span className="text-sm text-slate-500">Ainda não tem uma caderneta? </span>
            <Link to="/cadastro" className="text-sm font-bold text-teal-600 hover:text-teal-700 transition-colors">
              Cadastre-se aqui
            </Link>
          </div>
          <div>
  ...
  <Link to="/admin" className="text-xs font-semibold text-slate-400 hover:text-teal-600 transition-colors">

...
routes.get('/', (_req, res) => {
  res.json({ sucesso: true, servico: 'easyvacc-backend' });
});
...
routes.get('/usuarios/cpf/:cpf', async (req, res) => {
  try {
...
routes.get('/vacinas/:usuarioId', async (req, res) => {
  try {
...
routes.post('/vacinas', async (req, res) => {
  try {
...
routes.get('/postos', async (req, res) => {
  try {
...
routes.get('/campanhas', async (req, res) => {
  try {
...
routes.get('/notificacoes/:usuarioId', async (req, res) => {
  try {
...
routes.get('/dependentes/:usuarioId', async (req, res) => {
  try {
...
routes.post('/dependentes', async (req, res) => {
  try {
...
sequelize.authenticate()
  .then(async () => {
    console.log("📦 Conectado ao banco Aiven com sucesso!");
